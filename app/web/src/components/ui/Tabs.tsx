 ...
 * Built on Radix UI with animated underline indicator
 */
...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ...
        className={cn(
            ...
            'ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2',
            'disabled:pointer-events-none disabled:opacity-50',
            'data-[state=active]:bg-white data-[state=active]:text-slate-950 data-[state=active]:shadow-sm',
            'dark:ring-offset-slate-950 dark:focus-visible:ring-slate-800',
