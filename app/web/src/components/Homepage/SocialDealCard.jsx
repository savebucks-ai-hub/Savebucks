        ...
        >
          <div className="flex gap-3 h-full">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center">
              ...
              {/* Title - Single line */}
              <h3 className="text-xs font-medium text-gray-800 line-clamp-1 group-hover:text-accent transition-colors mb-1">
                {deal.title}
              </h3>
              ...
              <div className="flex items-center gap-1.5">
                ...
                {discount > 0 && (
                  <span className="text-[10px] font-semibold px-1 rounded bg-brand-tint text-brand-text">
                    -{discount}%
                  </span>
                )}
              </div>
            ...
            <div className="flex flex-col items-end justify-between flex-shrink-0">
              {/* Vote */}
              <div className={`flex items-center gap-0.5 text-[10px] ${votes > 0 ? 'text-accent' : 'text-gray-400'}`}>
