...
function ToastItem({ toast, onRemove }) {
  ...
  return (
    <div
      className={clsx(
        'pointer-events-auto flex items-center p-4 border rounded-lg shadow-lg max-w-sm',
    ...
    >
      ...
      <button
        ...
        className="flex-shrink-0 ml-3 p-1 rounded hover:bg-black hover:bg-opacity-10 focus-ring"
        aria-label="Dismiss"
      >
...
// Default export for easy mounting
